...
import { supabase } from '../services/SupabaseClient'
 ...
 const getMinmum= ()=>{
     return  useQuery({
      queryKey : ["minmum"] ,
      queryFn : async()=>{
         const {data  ,  error } = await supabase.from("minmumePrice").select("*").single()
