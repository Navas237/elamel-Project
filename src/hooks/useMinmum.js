...
export const useMinimum = (total) => {

     if(total <= 300){

        Swal.fire({
                  // title: "عفوا الحد الادني للطلب 300 جنيه ",
                  html: `<p class="font-bold text-[17px]"> فاضلك ( ${300 - total} جنية)  لإكمال الطلب الحد الأدني  (300 جنية) 
                   </p>
